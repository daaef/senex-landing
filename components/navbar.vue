    ...
    <div class="container" style="margin-top: 0.8rem; padding-top: 0;">
      <div class="navbar-brand">
        <a class="" @click.prevent="$router.push('/')">
          <img v-if="logoVariant === 'white'" src="~assets/senexpay-logo-light.png" alt="SenexPAY" style="height: 35px; margin-top: 5px;">
          <img v-else src="~assets/senexpay-logo.png" alt="SenexPAY" style="height: 35px; margin-top: 5px;">
        </a>
        <span
